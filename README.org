...
Then, using the emulator calibrated based on the CMIP climate models,
10,000 temperature trajectories are simulated, both with and without a unit emission pulse (1 GtCO2, 1 MtCH4, or 1 MtN2O).
...
*** STEP 3: concentration projections to temperature projections
